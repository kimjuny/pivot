 ...
 * Supports desktop and mobile modes with different behaviors.
 */
...
/**
 * Trigger button to toggle sidebar visibility.
 */
...
/**
 * Rail component for sidebar resize/toggle interaction.
 */
...
/**
 * Inset container for sidebar content.
 */
...
/**
 * Header section of sidebar (sticky at top).
 */
...
/**
 * Footer section of sidebar (sticky at bottom).
 */
...
/**
 * Group container for sidebar sections.
 */
...
/**
 * Action button for sidebar group header.
 */
...
/**
 * Content container for sidebar group.
 */
...
/**
 * Menu container for sidebar items.
 */
...
const sidebarMenuButtonVariants = cva(
    "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>span]:whitespace-nowrap [&>span]:transition-opacity [&>span]:duration-200 [&>span]:ease-in-out group-data-[collapsible=icon]:[&>span]:opacity-0 [&>svg]:size-4 [&>svg]:shrink-0",
    {
        variants: {
            variant: {
 ...
 * Supports tooltip when sidebar is collapsed.
 */
...
>(({ className, showIcon = false, ...props }, ref) => {
    // Random width for loading skeleton
