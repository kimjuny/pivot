 ...
 * Automatically redirects to the Consumer home if user is already logged in.
 */
function LoginPage() {
  ...
  /**
   * Redirect to the Consumer home if already logged in.
   */
  useEffect(() => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    void (async () => {
      try {
        ...
        // Why: Consumer is the shared default entrypoint for all authenticated
        // users, while Studio remains reachable as a role-gated workspace.
        navigate('/app', { replace: true });
      } catch (error) {
