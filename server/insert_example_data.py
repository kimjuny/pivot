...
for subscene_data in subscenes_data:
    response = requests.post(f'{API_BASE_URL}/scenes/{scene_id}/subscenes', json=subscene_data)
...
for connection_data in connections_data:
    ...
    if from_subscene_id and to_subscene_id:
        ...
        response = requests.post(f'{API_BASE_URL}/subscenes/{from_subscene_id}/connections', json=connection_data)
        connection = response.json()
        print(f"Created connection: {connection}")
    else:
        print(f"Warning: Could not find subscene IDs for connection: {connection_data['name']}")
