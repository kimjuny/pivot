...
class ReactRecursion(SQLModel, table=True):
    ...
    Attributes:
        ...
        action_type: Type of action (CALL_TOOL, PLAN, ANSWER, REFLECT).
    ...
    input_message_json: str | None = Field(
        default=None,
    ...
    action_type: str | None = Field(
        default=None,
        description="Action type: CALL_TOOL, PLAN, ANSWER, REFLECT",
    )
...
class ReactPlanStep(SQLModel, table=True):
    ...
    Plan steps are generated by the LLM during PLAN action and guide
